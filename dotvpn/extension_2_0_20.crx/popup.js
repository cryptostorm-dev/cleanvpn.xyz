...
function updateUI() {
  ...
  $('#country-label').text(
    $('#selectcountry [data-code="' + bkg.settings.location + '"]').text());
...
function showMainView() {
  ...
  switch (bkg.settings.event) {
    ...
    case 3:
      turboStartEventHandler();
      break;

    case 4:
      turboEndEventHandler();
      break;
...
$('#selectcountry > div').click(function() {
  ...
  if (code != bkg.settings.location) {
    ...
    updateUI();
    switchProxyState(function() {
      window.setTimeout(updateUI, connectDelay);
    });
  }
});
...
$('#crash-reporting').click(function() {
  updateSwitchSetting('crashReporting', this);
});
...
$('#change-password-popup .button-checked').click(function() {
...
$('#support-popup .button-checked').click(function() {
  $('.icon-close').trigger('click');
});
...
$('#improve-popup .button-checked').click(function() {
  $('.icon-close').trigger('click');
});
...
function turboStartEventHandler() {
  $('#turbo-start-box').show();

  updateNotification(3, 'view');
}

function turboEndEventHandler() {
  $('#turbo-end-box').show();
