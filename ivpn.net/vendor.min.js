 ...
 */
(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else{a(jQuery)}}(function(c){var a=/\+/g;function d(f){if(b.raw){return f}return decodeURIComponent(f.replace(a," "))}function e(f){if(f.indexOf('"')===0){f=f.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\")}f=d(f);try{return b.json?JSON.parse(f):f}catch(g){}}var b=c.cookie=function(n,m,r){if(m!==undefined){r=c.extend({},b.defaults,r);if(typeof r.expires==="number"){var o=r.expires,q=r.expires=new Date();q.setDate(q.getDate()+o)}m=b.json?JSON.stringify(m):String(m);return(document.cookie=[b.raw?n:encodeURIComponent(n),"=",b.raw?m:encodeURIComponent(m),r.expires?"; expires="+r.expires.toUTCString():"",r.path?"; path="+r.path:"",r.domain?"; domain="+r.domain:"",r.secure?"; secure":""].join(""))}var p=document.cookie.split("; ");var s=n?undefined:{};for(var k=0,h=p.length;k<h;k++){var j=p[k].split("=");var f=d(j.shift());var g=j.join("=");if(n&&n===f){s=e(g);break}if(!n){s[f]=e(g)}}return s};b.defaults={};c.removeCookie=function(g,f){if(c.cookie(g)!==undefined){c.cookie(g,"",c.extend({},f,{expires:-1}));return true}return false}}));(function(a,b){a.extend(a.fn.socialSharePrivacy.settings,{perma_option:true,set_perma_option:function(c){localStorage.setItem("socialSharePrivacy_"+c,"perma_on")},del_perma_option:function(c){localStorage.removeItem("socialSharePrivacy_"+c)},get_perma_options:null,get_perma_option:function(c){return localStorage.getItem("socialSharePrivacy_"+c)==="perma_on"}})})(jQuery);jQuery(document).ready(function(){jQuery(".tab-content").hide();if(jQuery(location).attr("hash").substr(1)!=""){var a=jQuery(location).attr("hash");jQuery("ul").find("li").removeClass("open");jQuery("ul.nav li").removeClass("active");jQuery(a+"nav").addClass("active");jQuery(a).show()}else{jQuery("#tabs ul.nav .nav-tabs li:first").addClass("active").show();jQuery(".tab-content:first").show()}jQuery("#tabs ul.nav li").click(function(){jQuery("ul").find("li").removeClass("open");jQuery("ul.nav li").removeClass("active");jQuery(this).addClass("active");var b=jQuery(this).find("a").attr("href");if(b.substr(0,1)=="#"&&b.substr(1)!=""){jQuery(".tab-content").hide();jQuery(b).fadeIn();return false}else{return true}})});function toggleCheckboxes(a){jQuery("."+a).attr("checked",!jQuery("."+a+":first").is(":checked"))}function disableFields(b,a){if(a){jQuery("."+b).attr("disabled","disabled")}else{jQuery("."+b).removeAttr("disabled")}}function popupWindow(i,b,a,f,e){var d=(screen.width-a)/2;var g=(screen.height-f)/2;if(d<0){d=0}if(g<0){g=0}var c="height="+f+",";c+="width="+a+",";c+="top="+g+",";c+="left="+d+",";c+=e;win=window.open(i,b,c);win.window.focus()}function extraTicketAttachment(a){jQuery("#"+a).append('<input type="file" name="attachments[]" style="width:70%;" /><br />');$("#"+a+' input[type="file"]:last-of-type').niceFileInput({height:"50"})}function rating_hover(c){var b=c.split("_");for(var a=1;a<=5;a++){if(a<=b[1]){document.getElementById(b[0]+"_"+a).style.background="url(images/rating_pos.png)"}if(a>b[1]){document.getElementById(b[0]+"_"+a).style.background="url(images/rating_neg.png)"}}}function rating_leave(b){for(var a=1;a<=5;a++){document.getElementById(b+"_"+a).style.background="url(images/rating_neg.png)"}}function rating_select(a,d,b){window.location="viewticket.php?tid="+a+"&c="+d+"&rating="+b}!function(d){var b='[data-toggle="dropdown"]',a=function(f){var e=d(f).on("click.dropdown.data-api",this.toggle);d("html").on("click.dropdown.data-api",function(){e.parent().removeClass("open")})};a.prototype={constructor:a,toggle:function(j){var i=d(this),h,f,g;if(i.is(".disabled, :disabled")){return}f=i.attr("data-target");if(!f){f=i.attr("href");f=f&&f.replace(/.*(?=#[^\s]*$)/,"")}h=d(f);h.length||(h=i.parent());g=h.hasClass("open");c();if(!g){h.toggleClass("open")}return false}};function c(){d(b).parent().removeClass("open")}d.fn.dropdown=function(e){return this.each(function(){var g=d(this),f=g.data("dropdown");if(!f){g.data("dropdown",(f=new a(this)))}if(typeof e=="string"){f[e].call(g)}})};d.fn.dropdown.Constructor=a;d(function(){d("html").on("click.dropdown.data-api",c);d("body").on("click.dropdown",".dropdown form",function(f){f.stopPropagation()}).on("click.dropdown.data-api",b,a.prototype.toggle)})}(window.jQuery);
